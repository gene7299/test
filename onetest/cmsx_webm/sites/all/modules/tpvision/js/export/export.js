                  ...
                  if ($("video#" + pl_item).length) {
                    ...
                    || navigator.userAgent.indexOf("BDL4550D") > -1) {
                      ...
                      if (isOldVideoLoad) {
                       ...
                       var html1 = '<video id="' + pl_item + '" style="' + css + '"><source src="' + src + '" type="video/webm"><source src="' + src + '" type="video/ogg"><source src="' + src + '" type="video/mov"></video>';
 ...
 function checkingVideoObjectInCurrentPage(video, id){
    ...
    if ($("#"+vid+" .broadcast-object").length == 0) {
        if($("#"+vid+" video").length){
            ...
            var html1 = '<video id="#video-'+vid+'" style="' + css + '"><source src="' + src + '" type="video/webm"></video>';
