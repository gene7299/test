      ...
      */
      if($(".menu-page-" + pageid + " .video-object .content-wrapper").length == 0 &&
          ...
          if ($("body").hasClass("page-website-view") && TVPlatform != "android") {
            ...
            $('#digitalvideo').html("<video class=\"dvideo\" width=\"1\" height=\"1\" autoplay> <source src=\"sites/all/modules/tpvision/view_website/dvideo.wem\" type=\"video/webm\"> <source src=\"sites/all/modules/tpvision/view_website/dvideo.webm\" type=\"video/ogg\"> </video>");
	    window.setTimeout(function() {
